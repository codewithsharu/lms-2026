...
app.get('/api/db-status', async (req, res) => {
  try {
    ...
    const expectedTableSchemas = {
      ...
      hosted_assessments: ['id', 'template_id', 'host_id', 'class_id', 'section_id', 'zone', 'allow_resume', 'duration_minutes', 'max_attempts', 'result_mode', 'publish_status', 'start_time', 'end_time', 'instructions', 'created_at', 'updated_at'],
