...
app.get('/api/db-status', async (req, res) => {
  try {
    ...
    const expectedTableSchemas = {
      ...
      hosted_assessments: ['id', 'template_id', 'host_id', 'class_id', 'section_id', 'zone', 'allow_resume', 'duration_minutes', 'max_attempts', 'result_mode', 'publish_status', 'start_time', 'end_time', 'coding_section', 'instructions', 'created_at', 'updated_at'],
      hosted_assessment_student_targets: ['id', 'hosted_assessment_id', 'student_id', 'created_at'],
